...
<title>Defect Tracker | Add User</title>
<jsp:include page="page/include/styleInfo.jsp"></jsp:include>
<!-- DataTables -->
<link rel="stylesheet"
	href="lib/plugins/datatables/dataTables.bootstrap.css">
</head>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a
						href="RedirectController?url=DashboardController&type=CONTROLLER"><i
